...
log_file = "log/late_fusion_st_gcn_joint_position.txt"
...
if __name__ == '__main__':
    ...
    for i in range(NUM_OF_TESTS):
        ...
        optimizer = torch.optim.SGD([{'params': model1.parameters()}, {'params': model2.parameters()}, {'params': fc.parameters()}], lr = learning_rate)
        # Train
