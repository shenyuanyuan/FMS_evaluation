...
from st_gcn_part import *

#(N, in_channels, T_{in}, V_{in}, M_{in})
log_file = "log/early_fusion_st_gcn_split_by_person.txt"
...
if __name__ == '__main__':
    ...
    for i in range(NUM_OF_TESTS):
        ...
        model = Model(2*joint_dim, num_class, graph_args, edge_importance_weighting=True)
