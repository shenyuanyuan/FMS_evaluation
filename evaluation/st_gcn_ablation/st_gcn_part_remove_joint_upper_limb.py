...
from graph_part_remove_joint_upper_limb import Graph
...
if __name__ == '__main__':
    ...
    model = Model(in_channels, num_class, graph_args, edge_importance_weighting=True)
    sample = torch.rand([32, 4, 200, 32, 1])
    output = model(sample)
    print(output)
