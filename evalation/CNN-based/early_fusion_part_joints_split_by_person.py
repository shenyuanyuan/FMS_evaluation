...
log_file = r"log\early_fusion_cnn_multi_scale_1248_dilation.txt"
...
if __name__ == '__main__':
    ...
    NUM_OF_TESTS = 10
    net_params = {'channel_params':[2*joint_dim*valid_joints_num, 64, 64], 'kernel_params_1':[3, 3], 'kernel_params_2':[3, 3], 'kernel_params_3':[3, 3], 'kernel_params_4':[3, 3], 'seq_len': 545, 'num_classes': 3}
